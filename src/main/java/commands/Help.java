        ...
        if(message[0].equals(prefix + "help") && !e.getAuthor().isBot()) {
            ...
            try {
                switch (message[1]) {
                    ...
                    case "wound" -> builder.addField("Wound Command", "Syntax: `" + prefix + "wound <user>`\nUsage: Totally wounds the target\nExample: `" + prefix + "wound 488487157372157962`", false);
