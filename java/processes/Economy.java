                ...
                case "leaderboard", "lb" -> {
                    ...
                    try {
                        switch (message[1]) {
                            ...
                            case "hours" -> new Leaderboard(":clock2:", "Most Hours Practised", e, "hoursPractised", (long) ((double) data.get("hoursPractised")));
                            ...
                            case "teach" -> new Leaderboard(":teacher:", "Most Influential Users", e, "hoursTaught", (long) ((double) data.get("hoursTaught")));
