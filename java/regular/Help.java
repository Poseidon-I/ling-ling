	...
	public Help(MessageReceivedEvent e) {
		...
		try {
			switch(message[1]) {
				...
				case "use" -> builder.addField("Use Command", "Syntax: `" + prefix + "use <id> [num]`\nUsage: Uses usable items like Ling Ling Insurance.  Spammable items like rice can be used in bulk.\nExample: `" + prefix + "use rice 5`", false);
