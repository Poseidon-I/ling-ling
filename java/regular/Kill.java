...
public class Kill {
    public Kill(GuildMessageReceivedEvent e, String targetPing) {
        ...
        if(targetPing.equalsIgnoreCase("i") || targetPing.toLowerCase().contains("ling ling") || targetPing.toLowerCase().contains("lingling") || targetPing.contains("733409243222507670")) {
