...
public class Stats {
    public Stats(GuildMessageReceivedEvent e, String[] data) {
        ...
        if (message.length == 1) {
            ...
            builder.addField("**__Violins__**", "**Highest Daily Streak**: " + data[74] + "\n**Luthiers Unscrambled**: " + data[77] + "\n**Violins Earned**: " + data[75], false);
