...
public class Upgrades {
    ...
    public static void Woodwinds(GuildMessageReceivedEvent e, String[] data, char prefix) {
        ...
        builder.addField("Flutes (" + data[21] + "/4)", "Price: " + 400000 * Long.parseLong(data[21] + 1) + "\nEffect: +60:violin:/hour\nID: `flute`", false)
                .addField("Oboes (" + data[22] + "/4)", "Price: " + 400000 * Long.parseLong(data[22] + 1) + "\nEffect: +50:violin:/hour\nID: `oboe`", false)
                .addField("Clarinets (" + data[23] + "/4)", "Price: " + 400000 * Long.parseLong(data[23] + 1) + "\nEffect: +40:violin:/hour\nID: `clarinet`", false)
                .addField("Bassoons (" + data[24] + "/4)", "Price: " + 400000 * Long.parseLong(data[24] + 1) + "\nEffect: +40:violin:/hour\nID: `bassoon`", false)
    ...
    public static void Brass(GuildMessageReceivedEvent e, String[] data, char prefix) {
        EmbedBuilder builder = new EmbedBuilder()
                .setColor(Color.BLUE)
                .setFooter("User balance: " + data[0] + "\nUse `" + prefix + "buy [ID]` to buy an upgrade!", e.getJDA().getSelfUser().getAvatarUrl())
                .addField("French Horns (" + data[26] + "/8)", "Price: " + 400000 * Long.parseLong(data[26] + 1) + "\nEffect: +40:violin:/hour\nID: `horn`", false)
                .addField("Trumpet (" + data[27] + "/4)", "Price: " + 300000 * Long.parseLong(data[27] + 1) + "\nEffect: +30:violin:/hour\nID: `trumpet`", false)
                .addField("Trombone (" + data[28] + "/6)", "Price: " + 250000 * Long.parseLong(data[28] + 1) + "\nEffect: +20:violin:/hour\nID: `trombone`", false)
                .addField("Tuba (" + data[29] + "/2)", "Price: " + 250000 * Long.parseLong(data[29] + 1) + "\nEffect: +20:violin:/hour\nID: `tuba`", false)
                .addField("Timpani (" + data[30] + "/2)", "Price: " + 400000 * Long.parseLong(data[30] + 1) + "\nEffect: +60:violin:/hour\nID: `timpani`", false)
