...
public class Upgrades {
	public static void IncomeUpgrades(MessageReceivedEvent e, JSONObject data, char prefix) {
		EmbedBuilder builder = new EmbedBuilder()
				...
				.addField("Skill Level (" + Numbers.FormatNumber(data.get("skills")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("skills"), 2, 500)) + ":violin:\nEffect: +250:violin:/hour\nID: `skill`, `s`", false)
				.addField("Lesson Quality (" + Numbers.FormatNumber(data.get("lessonQuality")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("lessonQuality"), 2, 400)) + ":violin:\nEffect: +200:violin:/hour\nID: `lesson`, `l`", false)
				.addField("String Quality (" + Numbers.FormatNumber(data.get("stringQuality")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("stringQuality"), 1.5, 300)) + ":violin:\nEffect: +150:violin:/hour\nID: `string`, `str`", false)
				.addField("Bow Quality (" + Numbers.FormatNumber(data.get("bowQuality")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("bowQuality"), 2.5, 600)) + ":violin:\nEffect: +250:violin:/hour\nID: `bow`, `b`", false)
	...
	public static void OrchMiscUpgrades(MessageReceivedEvent e, JSONObject data, char prefix) {
		...
		if(!(boolean) data.get("orchestra")) {
			if((long) data.get("hall") == 3) {
				builder.addField("Concert Hall Quality :white_check_mark:", "Effect: +300:violin:/hour, +10% violins from `" + prefix + "scales`, `" + prefix + "practice` `" + prefix + "rehearse` and `" + prefix + "perform`\nID: `concert`, `hall`", false);
			} else {
				builder.addField("Concert Hall Quality (" + Numbers.FormatNumber(data.get("hall")) + "/3)", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("hall"), 4, 100000)) + ":violin:\nEffect: +300:violin:/hour, +10% violins from `" + prefix + "scales`, `" + prefix + "practice` `" + prefix + "rehearse` and `" + prefix + "perform`\nID: `concert`, `hall`", false);
			}
			builder.addField("Orchestra", "Price: 25 000 000:violin:\nIncome Requirement: 7 500\nEffect: +3 100:violin:/hour, access to `" + prefix + "rehearse` command\nID:`orchestra`, `o`", false);
		} else if(!(boolean) data.get("certificate")) {
			builder.addField("Concert Hall Quality (" + Numbers.FormatNumber(data.get("hall")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("hall"), 4, 100000)) + ":violin:\nEffect: +300:violin:/hour, +10% violins from `" + prefix + "scales`, `" + prefix + "practice` `" + prefix + "rehearse` and `" + prefix + "perform`\nID: `concert`, `hall`", false)
			...
			if((long) data.get("advertising") == 20) {
				builder.addField("Advertising :white_check_mark:", "Effect: +100:violin:/hour\nID: `advertisement`, `ad`", false);
			} else {
				builder.addField("Advertising (" + Numbers.FormatNumber(data.get("advertising")) + "/20)", "Price: " + Numbers.FormatNumber(100000 * ((long) data.get("advertising") + 1)) + ":violin:\nEffect: +100:violin:/hour\nID: `advertisement`, `ad`", false);
			}
			builder.addField("Teaching Certificate", "Price: 200 000 000:violin:\nIncome Requirement: 40 000:violin:/hr\nEffect: +5 000:violin:/hr, access to `" + prefix + "teach` command\nID: `certificate`", false);
		} else {
			builder.addField("Concert Hall Quality (" + Numbers.FormatNumber(data.get("hall")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("hall"), 4, 100000)) + ":violin:\nEffect: +300:violin:/hour, +10% violins from `" + prefix + "scales`, `" + prefix + "practice` `" + prefix + "rehearse` and `" + prefix + "perform`\nID: `concert`, `hall`", false)
					.addField("Conductor Musicality (" + Numbers.FormatNumber(data.get("conductor")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("conductor"), 3, 100000)) + ":violin:\nEffect: +500:violin:/hour\nID: `conductor`, `musicality`", false)
					.addField("Ticket Price (" + Numbers.FormatNumber(data.get("tickets")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("tickets"), 2, 1000000)) + ":violin:\nEffect: +1000:violin:/hour\nID: `tickets`", false);
			if((long) data.get("advertising") == 20) {
				builder.addField("Advertising :white_check_mark:", "Effect: +100:violin:/hour\nID: `advertisement`, `ad`", false);
			} else {
	...
	public static void OtherMiscUpgrades(MessageReceivedEvent e, JSONObject data, char prefix) {
		...
		if((long) data.get("efficiency") < 25) {
			builder.addField("Efficient Practising (" + Numbers.FormatNumber(data.get("efficiency")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("efficiency"), 1.1, 400)) + ":violin:\nEffect: Increases your income from `" + prefix + "scales`, `" + prefix + "practice`, `" + prefix + "rehearse`, and `" + prefix + "perform` by 8%.\nID: `efficiency`, `ep`", false);
		} else if((long) data.get("efficiency") < 150) {
			builder.addField("Efficient Practising (" + Numbers.FormatNumber(data.get("efficiency")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("efficiency"), 1.1, 400)) + ":violin:\nEffect: Increases your income from `" + prefix + "scales`, `" + prefix + "practice`, `" + prefix + "rehearse`, and `" + prefix + "perform` by 4%.\nID: `efficiency`, `ep`", false);
		} else if((long) data.get("efficiency") < 200) {
			builder.addField("Efficient Practising (" + Numbers.FormatNumber(data.get("efficiency")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("efficiency"), 1.1, 400)) + ":violin:\nEffect: Increases your income from `" + prefix + "scales`, `" + prefix + "practice`, `" + prefix + "rehearse`, and `" + prefix + "perform` by 2%.\nID: `efficiency`, `ep`", false);
		} else {
			builder.addField("Efficient Practising (" + Numbers.FormatNumber(data.get("efficiency")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("efficiency") - 200, 1.2, 75962110584L)) + ":violin:\nEffect: Increases your income from `" + prefix + "scales`, `" + prefix + "practice`, `" + prefix + "rehearse`, and `" + prefix + "perform` by 2%.\nID: `efficiency`, `ep`", false);
		}
		if((long) data.get("luck") == 50) {
			builder.addField("Lucky Musician :white_check_mark:", "Effect: Increases your gambling multiplier by 0.5%.\nID: `lucky`, `lm`", false);
		} else {
			builder.addField("Lucky Musician (" + Numbers.FormatNumber(data.get("luck")) + "/50)", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("luck"), 1.25, 1000)) + ":violin:\nEffect: Increases your gambling multiplier by 0.5%.\nID: `lucky`, `lm`", false);
		}
		if((long) data.get("sophistication") == 30) {
			builder.addField("Sophisticated Robbing :white_check_mark:", "Effect: Increases your chance of a successful `" + prefix + "rob` by 0.25%.\nID: `sophistication`, `sr`", false);
		} else {
			builder.addField("Sophisticated Robbing (" + Numbers.FormatNumber(data.get("sophistication")) + "/30)", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("sophistication"), 1.4, 5000)) + ":violin:\nEffect: Increases your chance of a successful `" + prefix + "rob` by 0.25%.\nID: `sophistication`, `sr`", false);
		}
		builder.addField("Magic Find (" + Numbers.FormatNumber(data.get("magicFindViolins")) + ")", "Price: " + Numbers.FormatNumber(Numbers.ItemCost((long) data.get("magicFindViolins"), 5, 2000000)) + ":violin:\nEffect: +1 Magic Find\nID: `magicfindv` `mfv`", false);
	...
	public static void MedalUpgrades(MessageReceivedEvent e, JSONObject data, char prefix) {
		EmbedBuilder builder = new EmbedBuilder()
				...
				.addField("Magic Find (" + Numbers.FormatNumber(data.get("magicFindMedals")) + ")", "Price: " + Numbers.FormatNumber((long) Math.pow(3, (long) data.get("magicFindMedals"))) + ":military_medal:\nEffect: +1 Magic Find\nID: `magicfindm` `mfm`", false);
		...
		if((boolean) data.get("duplicator")) {
			builder.addField("Violin Duplicator :white_check_mark:", "Effect: The Vengeful God of Ben Lee duplicates all violins you steal", false);
		} else {
	...
	public static void Woodwinds(MessageReceivedEvent e, JSONObject data, char prefix) {
		...
		if((long) data.get("flute") == 4) {
			builder.addField("Flutes :white_check_mark:", "Effect: +60:violin:/hour\nID: `flute`", false);
		} else {
		...
		if((long) data.get("oboe") == 4) {
			builder.addField("Oboes :white_check_mark:", "Effect: +50:violin:/hour\nID: `oboe`", false);
		} else {
			builder.addField("Oboes (" + Numbers.FormatNumber(data.get("oboe")) + "/4)", "Price: " + Numbers.FormatNumber(250000 * ((long) data.get("oboe") + 1)) + ":violin:\nEffect: +50:violin:/hour\nID: `oboe`", false);
		}
		if((long) data.get("clarinet") == 4) {
			builder.addField("Clarinets :white_check_mark:", "Effect: +40:violin:/hour\nID: `clarinet`", false);
		} else {
			builder.addField("Clarinets (" + Numbers.FormatNumber(data.get("clarinet")) + "/4)", "Price: " + Numbers.FormatNumber(200000 * ((long) data.get("clarinet") + 1)) + ":violin:\nEffect: +40:violin:/hour\nID: `clarinet`", false);
		}
		if((long) data.get("bassoon") == 4) {
			builder.addField("Bassoons :white_check_mark:", "Effect: +40:violin:/hour\nID: `bassoon`", false);
		} else {
			builder.addField("Bassoons (" + Numbers.FormatNumber(data.get("bassoon")) + "/4)", "Price: " + Numbers.FormatNumber(200000 * ((long) data.get("bassoon") + 1)) + ":violin:\nEffect: +40:violin:/hour\nID: `bassoon`", false);
		}
	...
	public static void Brass(MessageReceivedEvent e, JSONObject data, char prefix) {
		...
		if((long) data.get("horn") == 8) {
			builder.addField("French Horns :white_check_mark:", "Effect: +40:violin:/hour\nID: `horn`", false);
		} else {
			builder.addField("French Horns (" + Numbers.FormatNumber(data.get("horn")) + "/8)", "Price: " + Numbers.FormatNumber(200000 * ((long) data.get("horn") + 1)) + ":violin:\nEffect: +40:violin:/hour\nID: `horn`", false);
		}
		if((long) data.get("trumpet") == 4) {
			builder.addField("Trumpet :white_check_mark:", "Effect: +30:violin:/hour\nID: `trumpet`", false);
		} else {
			builder.addField("Trumpet (" + Numbers.FormatNumber(data.get("trumpet")) + "/4)", "Price: " + Numbers.FormatNumber(200000 * ((long) data.get("trumpet") + 1)) + ":violin:\nEffect: +30:violin:/hour\nID: `trumpet`", false);
		}
		if((long) data.get("trombone") == 6) {
			builder.addField("Trombone :white_check_mark:", "Effect: +20:violin:/hour\nID: `trombone`", false);
		} else {
			builder.addField("Trombone (" + Numbers.FormatNumber(data.get("trombone")) + "/6)", "Price: " + Numbers.FormatNumber(200000 * ((long) data.get("trombone") + 1)) + ":violin:\nEffect: +20:violin:/hour\nID: `trombone`", false);
		}
		if((long) data.get("tuba") == 2) {
			builder.addField("Tuba :white_check_mark:", "Effect: +20:violin:/hour\nID: `tuba`", false);
		} else {
			builder.addField("Tuba (" + Numbers.FormatNumber(data.get("tuba")) + "/2)", "Price: " + Numbers.FormatNumber(200000 * ((long) data.get("tuba") + 1)) + ":violin:\nEffect: +20:violin:/hour\nID: `tuba`", false);
		}
		if((long) data.get("timpani") == 2) {
			builder.addField("Timpani :white_check_mark:", "Effect: +60:violin:/hour\nID: `timpani`", false);
		} else {
			builder.addField("Timpani (" + Numbers.FormatNumber(data.get("timpani")) + "/2)", "Price: " + Numbers.FormatNumber(250000 * ((long) data.get("timpani") + 1)) + ":violin:\nEffect: +60:violin:/hour\nID: `timpani`", false);
		}
		if((long) data.get("percussion") == 2) {
			builder.addField("Percussionists :white_check_mark:", "Effect: +10:violin:/hour\nID: `percussion`", false);
		} else {
			builder.addField("Percussionists (" + Numbers.FormatNumber(data.get("percussion")) + "/2)", "Price: " + Numbers.FormatNumber(100000 * ((long) data.get("percussion") + 1)) + ":violin:\nEffect: +10:violin:/hour\nID: `percussion`", false);
		}
		e.getMessage().replyEmbeds(builder.build()).mentionRepliedUser(false).queue();
	}
	...
	public static void Strings(MessageReceivedEvent e, JSONObject data, char prefix) {
		...
		if((long) data.get("violin1") == 20) {
			builder.addField("Violin I :white_check_mark:", "Effect: +70:violin:/hour\nID: `first`", false);
		} else {
			builder.addField("Violin I (" + Numbers.FormatNumber(data.get("violin1")) + "/20)", "Price: " + Numbers.FormatNumber(450000 * (long) data.get("violin1")) + ":violin:\nEffect: +70:violin:/hour\nID: `first`", false);
		}
		if((long) data.get("violin2") == 20) {
			builder.addField("Violin II :white_check_mark:", "Effect: +60:violin:/hour\nID: `second`", false);
		} else {
			builder.addField("Violin II (" + Numbers.FormatNumber(data.get("violin2")) + "/20)", "Price: " + Numbers.FormatNumber(350000 * (long) data.get("violin2")) + ":violin:\nEffect: +60:violin:/hour\nID: `second`", false);
		}
		if((long) data.get("cello") == 15) {
			builder.addField("Cellos :white_check_mark:", "Effect: +50:violin:/hour\nID: `cello`", false);
		} else {
			builder.addField("Cellos (" + Numbers.FormatNumber(data.get("cello")) + "/15)", "Price: " + Numbers.FormatNumber(300000 * ((long) data.get("cello") + 1)) + ":violin:\nEffect: +50:violin:/hour\nID: `cello`", false);
		}
		if((long) data.get("doubleBass") == 5) {
			builder.addField("Double Basses :white_check_mark:", "Effect: +50:violin:/hour\nID: `doublebass`, `db`", false);
		} else {
			builder.addField("Double Basses (" + Numbers.FormatNumber(data.get("doubleBass")) + "/5)", "Price: " + Numbers.FormatNumber(300000 * ((long) data.get("doubleBass") + 1)) + ":violin:\nEffect: +50:violin:/hour\nID: `doublebass`, `db`", false);
		}
		if((long) data.get("piano") == 2) {
			builder.addField("Pianists :white_check_mark:", "Effect: +110:violin:/hour\nID: `piano`", false);
		} else {
			builder.addField("Pianists (" + Numbers.FormatNumber(data.get("piano")) + "/2)", "Price: " + Numbers.FormatNumber(750000 * ((long) data.get("piano") + 1)) + ":violin:\nEffect: +110:violin:/hour\nID: `piano`", false);
		}
	...
	public static void Choir(MessageReceivedEvent e, JSONObject data, char prefix) {
		...
		if((long) data.get("soprano") == 20) {
			builder.addField("Sopranos :white_check_mark:", "Effect: +30:violin:/hour\nID: `soprano`", false);
		} else {
			builder.addField("Sopranos (" + Numbers.FormatNumber(data.get("soprano")) + "/20)", "Price: " + Numbers.FormatNumber(80000 * ((long) data.get("soprano") + 1)) + ":violin:\nEffect: +30:violin:/hour\nID: `soprano`", false);
		}
		if((long) data.get("alto") == 20) {
			builder.addField("Altos :white_check_mark:", "Effect: +20:violin:/hour\nID: `alto`", false);
		} else {
			builder.addField("Altos (" + Numbers.FormatNumber(data.get("alto")) + "/20)", "Price: " + Numbers.FormatNumber(60000 * ((long) data.get("alto") + 1)) + ":violin:\nEffect: +20:violin:/hour\nID: `alto`", false);
		}
		if((long) data.get("tenor") == 20) {
			builder.addField("Tenors :white_check_mark:", "Effect: +20:violin:/hour\nID: `tenor`", false);
		} else {
			builder.addField("Tenors (" + Numbers.FormatNumber(data.get("tenor")) + "/20)", "Price: " + Numbers.FormatNumber(60000 * ((long) data.get("tenor") + 1)) + ":violin:\nEffect: +20:violin:/hour\nID: `tenor`", false);
		}
		if((long) data.get("bass") == 20) {
			builder.addField("Basses :white_check_mark:", "Effect: +20:violin:/hour\nID: `bass`", false);
		} else {
			builder.addField("Basses (" + Numbers.FormatNumber(data.get("bass")) + "/20)", "Price: " + Numbers.FormatNumber(60000 * ((long) data.get("bass") + 1)) + ":violin:\nEffect: +20:violin:/hour\nID: `bass`", false);
		}
		if((long) data.get("soloist") == 4) {
			builder.addField("Vocal Soloists :white_check_mark:", "Effect: +60:violin:/hour\nID: `soloist`", false);
		} else {
			builder.addField("Vocal Soloists (" + Numbers.FormatNumber(data.get("soloist")) + "/4)", "Price: " + Numbers.FormatNumber(250000 * ((long) data.get("soloist") + 1)) + ":violin:\nEffect: +60:violin:/hour\nID: `soloist`", false);
		}
		e.getMessage().replyEmbeds(builder.build()).mentionRepliedUser(false).queue();
	}
	...
	public static void TeacherUpgrades(MessageReceivedEvent e, JSONObject data, char prefix) {
		EmbedBuilder builder = new EmbedBuilder()
				...
				.setTitle("__**Teacher Upgrades**__");
		if((long) data.get("lessonCharge") == 5) {
			builder.addField("Higher Lesson Rates :white_check_mark:", "Effect: +3 000:violin:/hour, +10% violins from `" + prefix + "teach`\nID: `pricing`", false);
		} else {
			builder.addField("Higher Lesson Rates (" + Numbers.FormatNumber(data.get("lessonCharge")) + "/5)", "Price: " + Numbers.FormatNumber(3000000 * ((long) data.get("lessonCharge") + 1)) + ":violin:\nEffect: +3 000:violin:/hour, +10% violins from `" + prefix + "teach`\nID: `pricing`", false);
		}
		if((long) data.get("training") == 10) {
			builder.addField("Teacher Training :white_check_mark:", "Effect: +1 000:violin:/hour, +5% violins from `" + prefix + "teach`\nID: `training`", false);
		} else {
			builder.addField("Teacher Training (" + Numbers.FormatNumber(data.get("training")) + "/10)", "Price: " + Numbers.FormatNumber(2000000 * ((long) data.get("training") + 1)) + ":violin:\nEffect: +1 000:violin:/hour, +5% violins from `" + prefix + "teach`\nID: `training`", false);
		}
	...
	public static void BankUpgrades(MessageReceivedEvent e, JSONObject data, char prefix) {
		EmbedBuilder builder = new EmbedBuilder()
				.setColor(Color.decode((String) data.get("color")))
				.setFooter("Medals: " + Numbers.FormatNumber(data.get("medals")) + "\nUse `" + prefix + "buy [ID]` to buy an upgrade!", e.getJDA().getSelfUser().getAvatarUrl())
				.addField("Storage Space (" + Numbers.FormatNumber(data.get("storage")) + ")", "Price: " + Numbers.FormatNumber(3 * (long) data.get("storage")) + ":military_medal:\nEffect: +20 000 000 bankspace\nID: `space`", false);
