...
public class Practise {
    public Practise(GuildMessageReceivedEvent e, String[] data) {
        ...
        if (time < Long.parseLong(data[1])) {
            ...
            if (num > 0.75) {
                ...
                if (num > 0.75) {
                    ...
                    e.getChannel().sendMessage("You decided to fake your practise session.  Ling Ling caught you in the act, and fined you " + violins * (income / 200000) + ":violin:").queue();
                    violins -= violins * (income / 200000);
                    base = 0;
                } else {
                    e.getChannel().sendMessage("You dropped your violin.  How shameful.  All cooldowns except daily and gamble have had one day added to them, and you were fined " + violins * (income / 100000) + ":violin: for being careless.").queue();
