...
class CreateThreadSlash implements Runnable {
	...
	public void run() {
		...
		switch(commandName) {
			...
			case "website" ->
					e.reply("Weebly is hard to use, so there is currently no website.  " +
							"Maybe in the future I'll get someone to make it, but for now, everything is on Google Sheets or Google Docs.");
