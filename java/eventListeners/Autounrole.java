	...
	public void onMessageReactionRemove(MessageReactionRemoveEvent e) {
		if(e.getChannel().getId().equals("734697501059448892") && !Objects.requireNonNull(e.getUser()).isBot()) {
			...
			if(emoji.contains("U+1f7e5")) {
				...
				e.getGuild().removeRoleFromMember(Objects.requireNonNull(e.getMember()), Objects.requireNonNull(e.getGuild().getRoleById("1146225956055433386"))).queue();
			} else if(emoji.contains("U+1f50c")) {
				e.getGuild().removeRoleFromMember(Objects.requireNonNull(e.getMember()), Objects.requireNonNull(e.getGuild().getRoleById("1220307273016938536"))).queue();
			} else if(emoji.equals("CustomEmoji:twoset(852784233819013150")) { //twoset
