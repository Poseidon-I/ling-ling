                    ...
                    switch (message[0]) {
                                ...
                                if(!hasOrchestra) {
                                    switch (message[1]) {
                                        ...
                                        case "3" -> {
                                            ...
                                            if (ownInsurance1) {
                                                builder.addField("Ling Ling Insurance - Plan 1 - Full Security (1/1)", "Price: 1000000\nEffect: When someone uses `" + prefix + "rob` on you, will protect all your violins from being stolen but you will pay 15% of what would have been stolen as insurance cost.\nID: `1`", false);
                                            } else {
                                                builder.addField("Ling Ling Insurance - Plan 1 - Full Security (0/1)", "Price: 1000000\nEffect: When someone uses `" + prefix + "rob` on you, will protect all your violins from being stolen but you will pay 15% of what would have been stolen as insurance cost.\nID: `1`", false);
                                            }
                                            if (ownInsurance2) {
                                                builder.addField("Ling Ling Insurance - Plan 2 - Half Security (1/1)", "Price: 1000000\nEffect: When someone uses `" + prefix + "rob` on you, will protect only 67% of your violins from being stolen but you don't pay any insurance costs.\nID: `2`", false);
                                            } else {
                        ...
                        case "orchestra", "o" -> {
                            ...
                            if(hasOrchestra) {
                                ...
                                e.getChannel().sendMessage("You don't have an orchestra yet!  Run `" + prefix + "buy orchestra` to get one!  Remember that you need 9 500 income per hour and 40 Million violins to hire one!").queue();
                            }
                        }
                        case "cooldowns", "c" -> {
                            if (!hasData) {
